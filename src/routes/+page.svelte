...
<section class="bg-card">
	...
	>
		...
		<div
			use:reveal={{ y: 24, delay: 150 }}
			class="order-1 overflow-hidden rounded-2xl md:order-2 md:rounded-3xl"
		>
			<img
				src="/nurse.jpeg"
...
>
	<article
		use:reveal={{ y: 24 }}
		class="flex flex-col rounded-2xl bg-blue-soft p-5 md:p-8"
	>
	...
	<article
		use:reveal={{ y: 24, delay: 120 }}
		class="flex flex-col rounded-2xl bg-red-soft p-5 md:p-8"
	>
	...
	<section class="mx-auto max-w-5xl px-4 pb-12">
		...
		<div class="mt-8 grid gap-6 md:grid-cols-2">
			{#if data.voteWinner}
				<div
					use:reveal={{ y: 24 }}
					class="rounded-2xl border-2 border-primary bg-card p-7"
				>
					<span
			...
			{#if data.storyWinner}
				<div
					use:reveal={{ y: 24, delay: 120 }}
					class="rounded-2xl border-2 border-accent bg-card p-7"
				>
					<span
